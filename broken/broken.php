...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background: linear-gradient(135deg, #FF0066 0%, #FFFF66 100%);
            color: #333;
        }
        header {
        ...
        .container::before {
            ...
            left: -10px;
            z-index: -1;
            background: linear-gradient(135deg, #FFFF66 0%, #FF0066 100%);
            border-radius: 15px;
            filter: blur(30px);
        }
        .filter-form {
...
<header>
    ...
    <div class="container">
        ...
        <form method="POST" action="update_statusbroken.php" class="H1">
            <?php
            $current_zone = '';
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($current_zone != $row['bay_name']) {
                        ...
                        echo "<div class='zone-header'>โซน $current_zone</div>";
                        echo "<table><thead>
                                <tr>
                    ...
                    echo "<tr class='{$status_class}'>
                            ...
                            <td>
                                <select name='status_{$row['lot_id']}'>
                                    <option value='1'" . ($row['status_id'] == 1 ? ' selected' : '') . ">ปกติ</option>
                                    <option value='7'" . ($row['status_id'] == 7 ? ' selected' : '') . ">จอด</option>
