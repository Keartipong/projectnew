...
<head>
    ...
    <style>
        ...
        /* Cascading code rain for Matrix-style effect */
        canvas {
            position: fixed;
            width: 100%;
            height: 100%;
        ...
        /* Neon Glitch effect for login title */
        @keyframes glitch {
...
<body>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="login-container">
            <h1 class="text-3xl text-center mb-8 glitch">Quantum Car System Login</h1>
            <form method="POST">
