...
<div class="container">
    ...
    <table id="historyTable">
        ...
        // คำสั่ง SQL เพื่อดึงข้อมูลจากตาราง history พร้อมกับข้อมูลจากตาราง lot
        $sql = "
            SELECT h.*, l.number as lot_number
            FROM history h
            JOIN lot l ON h.lot_id = l.lot_id
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row["time_out"] . "</td>"; // แสดง Time Out
                echo "</tr>";
        ...
        // คำสั่ง SQL เพื่อหาจำนวนรวมของข้อมูลในตาราง history
